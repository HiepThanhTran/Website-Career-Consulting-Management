...
class CVMajor(View):
    def get(self, request):
        return render(request, template_name='cv/cv_major.html')
...
class CVManagement(LoginRequiredMixin, View):
    def get(self, request):
        ...
        return render(request, template_name='cv/cv.html', context={
            'cvs': cvs,
        })
...
class UploadCV(LoginRequiredMixin, View):
    def get(self, request):
        return render(request, template_name='cv/upload_cv.html')
...
class CVTemplate(View):
    def get(self, request):
        return render(request, template_name='cv/cv_template.html')
